...
const DemoData = {
      ...
      work4: {
        ...
        promotion:{
          ...
          contentStrategy:'抖音"成分实验室"系列 + 小红书"妈妈真实体验"系列 + 淘宝"配方溯源"长图。'
            ...
            work5: {
        cover: { title:'豆芽妈妈 · 2027 渠道升级与品牌年轻化策划书', subtitle:'看得见的成分，安心的呵护——从淘宝老店到全渠道国货母婴成分派', team:'豆芽妈妈团队', date:'2026-08' },
        abstract: '本策划书围绕豆芽妈妈从淘宝 5 年老店向“淘宝+抖音+小红书”全渠道升级展开。业务价值体系（Work 1）确认 0-3 岁婴幼儿洗护为核心 SBU，38% 复购率与 5 万私域老客是最大资产；目标市场（Work 2）锁定一线精致妈妈为首攻客群；价值主张（Work 3）收敛为“看得见的成分，安心的呵护”，以成分透明、儿科医生背书、红 PP 急救三大卖点支撑；营销组合（Work 4）设计 6 个月抖音冷启动 + 12 个月全渠道联动的节奏。核心目标：12 个月内抖音 GMV 占总营收 25%，3 年内成为“国货母婴成分派”代表品牌。',
        ...
        references: [
          ...
          { authors:'内部台账', title:'2024 年复购与渠道数据', year:'2025', url:'' }
        ],
        lastAggregated: null
      }
    },
      ...
      work4: {
        ...
        promotion:{
          ...
          contentStrategy:'抖音"老陈手作 30 年"系列 + 小红书"融合菜出片"系列 + 大众点评"食材故事"长图。'
            ...
            work5: {
        cover: { title:'小镬记 · 广州品牌升级与连锁扩张策划书', subtitle:'30 年老店，新派粤菜——从两家直营到深圳连锁', team:'小镬记家族团队', date:'2026-08' },
        abstract: '本策划书围绕小镬记从广州 2 家直营店向“品牌升级+深圳连锁”扩张展开。业务价值体系（Work 1）确认核心资产是“30 年老店信任 + 5 位粤菜师傅 + 15 道招牌菜”，口碑与复购是增长引擎；目标市场（Work 2）经专家评估锁定深圳粤菜融合新客为首攻市场；价值主张（Work 3）收敛为“30 年老店，新派粤菜”，老店的确定性与新派的差异化双支撑；营销组合（Work 4）设计“广州立品牌、深圳建样板、连锁跑模型”三阶段节奏。核心目标：18 个月内深圳首店盈利，36 个月复制 3-5 家直营。',
        ...
        references: [
          { authors:'内部台账', title:'2025 年两店营收与坪效数据', year:'2025', url:'' },
          { authors:'', title:'2024 深圳餐饮消费数据', year:'2024', url:'' },
          { authors:'', title:'抖音同城餐饮内容趋势报告', year:'2024', url:'' }
        ],
        lastAggregated: null
      }
    },
      ...
      work4: {
        ...
        promotion:{
          ...
          contentStrategy:'抖音"老师司龄 5 年"系列 + 小红书"学员成长档案"系列 + 公众号"学习报告"长图。'
            ...
            work5: {
        cover: { title:'问渠书院 · K12 素质与职业培训双线转型策划书', subtitle:'问渠书院，成长陪伴——从少儿素质到终身成长', team:'问渠书院管理团队', date:'2026-08' },
        abstract: '本策划书围绕问渠书院从 K12 素质单线向“素质+职业”双线转型展开。业务价值体系（Work 1）确认 3 校区 70% 续费率与“老师稳定”是核心资产；目标市场（Work 2）评估锁定大学生/职场新人为职业线首攻客群；价值主张（Work 3）收敛为“问渠书院，成长陪伴”，把陪伴从少儿延续到成人；营销组合（Work 4）设计“存量 K12 盘活 + 职业线冷启动”双线节奏。核心目标：18 个月内职业线营收占比 30%，成为区域“成长陪伴”心智品牌。',
        ...
        references: [
          { authors:'内部台账', title:'2025 年三校区续费与课消数据', year:'2025', url:'' },
          { authors:'', title:'职业教育法（2022 修订）', year:'2022', url:'' },
          { authors:'', title:'2024 大学生就业质量报告', year:'2024', url:'' }
        ],
        lastAggregated: null
      }
    },
      ...
      work4: {
        ...
        promotion:{
          ...
          contentStrategy:'官网"恒锐造案例墙"系列 + 公众号"0.005mm 的精密"长文 + 行业展会"工艺纪录片"。'
            ...
            work5: {
        cover: { title:'恒锐精密 · 从 OEM 到自有品牌双轮转型策划书', subtitle:'恒锐造，0.005mm 的精密——让中小品牌方用上顶级精密件', team:'恒锐精密转型小组', date:'2026-08' },
        abstract: '本策划书围绕恒锐精密从纯 OEM 向“OEM+自有品牌”双轮转型展开。业务价值体系（Work 1）确认 0.005mm 精度与 SPC 体系是核心资产，大客户占 40% 的砍单风险是转型动因；目标市场（Work 2）锁定专精特新中小品牌方为首攻客群；价值主张（Work 3）收敛为“恒锐造，0.005mm 的精密”；营销组合（Work 4）设计“OEM 基本盘护住现金流 + 自有品牌单点突破”的双轮节奏。核心目标：24 个月内自有品牌营收占比 20%，客户结构从单一大客户走向多元。',
        ...
        references: [
          { authors:'内部台账', title:'2025 年客户结构与产能数据', year:'2025', url:'' },
          { authors:'', title:'专精特新中小企业培育政策', year:'2024', url:'' },
          { authors:'', title:'中国精密制造产业报告', year:'2024', url:'' }
        ],
        lastAggregated: null
      }
    },
      ...
      work4: {
        ...
        promotion:{
          ...
          contentStrategy:'抖音"无应激洗护+实时直播"系列 + 小红书"科学养宠"系列 + 公众号"CKU 认证洗护师"长文。'
            ...
            work5: {
        cover: { title:'毛孩子之家 · 区域宠物服务品牌扩张策划书', subtitle:'毛孩子放心，毛孩子之家——从 2 家门店到 5 家区域品牌', team:'毛孩子之家团队', date:'2026-08' },
        abstract: '本策划书围绕毛孩子之家从成都/重庆 2 家直营门店向“5 家直营+区域品牌”扩张展开。业务价值体系（Work 1）确认 45% 复购率与洗护师认证是核心资产；目标市场（Work 2）锁定成都核心区域加密 2-3 家新店为首阶段；价值主张（Work 3）收敛为“毛孩子放心，毛孩子之家”；营销组合（Work 4）设计“门店体验+私域复购+社群裂变”的单店模型。核心目标：24 个月 5 家直营门店，跑通模型后向周边城市复制。',
        ...
        references: [
          { authors:'内部台账', title:'2025 年两店复购与客单数据', year:'2025', url:'' },
          { authors:'', title:'2024 中国宠物行业白皮书', year:'2024', url:'' },
          { authors:'', title:'成都养宠人群消费数据', year:'2024', url:'' }
        ],
        lastAggregated: null
      }
    }
  ...
  inject(caseKey, s) {
    ...
    // 演示 case 的 valueChain 写在 meta.valueChain，注入时镜像到 work1.environment.valueChain
    // 让微笑曲线 gate 在演示态直接放行（gate 检查 work1.environment.valueChain）。
    if(c.meta && c.meta.valueChain && c.meta.valueChain.nodes){
      s.work1 = s.work1 || {};
      s.work1.environment = s.work1.environment || {};
      if(!Array.isArray(s.work1.environment.valueChain) || !s.work1.environment.valueChain.length){
        s.work1.environment.valueChain = c.meta.valueChain.nodes.map(n=>({
          label: n.label, v: n.v, reason: n.reason || n.tip || ''
        }));
      }
    }
